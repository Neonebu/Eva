...
namespace Eva.Services
{
    public class TradeService : ITradeService
    {
        ...
        public async Task<bool> BuyShares(string email, int portfolioId, string symbol, int quantity)
        {
            ...
            if (portfolio == null || portfolio.UserEmail != email) return false;
        ...
        public async Task<bool> SellShares(string email, int portfolioId, string symbol, int quantity)
        {
            var share = await _shareRepository.GetBySymbolAsync(symbol);
            if (share == null) return false;
